...
def fit(cfg, opt):
    X = np.load("/home/share/fuerBuschjaeger/threesieves/examiner/examiner.npy")
...
X = np.load("/home/share/fuerBuschjaeger/threesieves/examiner/examiner.npy") #, mmap_mode="r"
