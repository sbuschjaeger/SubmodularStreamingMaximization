...
public:
    ...
    // virtual data_t operator()(std::vector<std::vector<data_t>> &cur_solution) {
    ...
    virtual data_t peek(std::vector<std::vector<data_t>> &cur_solution, std::vector<data_t> const &x) = 0; 

    virtual void update(std::vector<std::vector<data_t>> &cur_solution, std::vector<data_t> const &x) = 0;
